// This package is gracefully copy-pasted from https://github.com/sssgun/grpc-quic.
// Updated to use with the latest quic-go.
...
func (c *Conn) Close() error {
	...
	if err := c.stream.Close(); err != nil {
		logrus.Warnf("error closing stream: %v", err)
	}
